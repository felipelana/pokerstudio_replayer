...
- Name: replayer.spec.ts >> do cadastro à primeira mão >> cria a conta, importa uma mão e anda por ela
- Location: tests\e2e\replayer.spec.ts:64:3

# Error details

```
Error: {"type":"https://pokerstudio.com.br/errors/rate_limited","title":"Too many requests. Slow down.","status":429,"code":"rate_limited"}
