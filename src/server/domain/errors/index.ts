...
export const Errors = {
  invalidCredentials: () =>
    appError('invalid_credentials', 'E-mail or password is incorrect.', 401),
  ...
  quotaExceeded: (what: string) =>
    appError('quota_exceeded', `Daily limit reached for ${what}.`, 429),
  ...
  twoFactorAlreadyEnrolled: () =>
    appError('two_factor_already_enrolled', 'Two-factor is already enabled.', 409),
  ...
  assessmentCompleted: () =>
    appError(
      ...
      'This assessment is complete and can no longer be changed.',
      409,
    ),
