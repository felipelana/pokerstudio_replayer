...
export const PRIVACY_POLICY: LegalDoc = {
  ...
  intro: `Esta Política explica como o PokerStudio Replayer trata dados pessoais. O controlador dos dados é ${OWNER}, inscrita sob ${DOC}, com sede em ${ADDRESS}. Dúvidas e pedidos relativos a dados pessoais: ${CONTACT}.`,
  sections: [
    {
...
export const TERMS_OF_USE: LegalDoc = {
  title: 'Termos de Uso',
  updatedAt: '2026-09-06',
  intro: `Estes Termos regem o uso do PokerStudio Replayer, oferecido por ${OWNER} (${DOC}). Ao criar uma conta ou usar o serviço, você concorda com eles. Se não concordar, não use o serviço.`,
  sections: [
    {
