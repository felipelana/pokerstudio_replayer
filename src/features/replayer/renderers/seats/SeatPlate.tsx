...
import type { PlayerState } from '@/domain/engine/replay';
...
import { IconSearch, IconSeat } from '@/components/ui/icons';
            ...
            >
              <div className="flip-in">
                <Card
                  ...
                  deck={skin.deck}
                  width={cardWidth}
                  art={c === 'back' ? undefined : deckArt?.[c[0]]}
                />
              </div>
            </div>
          ))}
      ...
      >
        <div className="flex items-center justify-center gap-1.5 truncate text-[13px] font-semibold leading-tight">
          {position && (
            <span
              ...
              style={{
                background: `color-mix(in srgb, ${p.text} 14%, transparent)`,
                color: p.textMuted,
              }}
            >
              {position}
        ...
        {(player.folded || player.allIn || player.sittingOut) && player.inHand && (
          <div
            ...
            style={{
              background: player.folded ? p.foldLabel : player.allIn ? p.allInLabel : p.foldLabel,
            }}
          >
