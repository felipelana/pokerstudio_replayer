...
import { hasUnread } from '@/lib/content/releaseNotes';
import { useAppStore } from '@/lib/state/store';
import { AboutDialog } from '@/features/onboarding/about/AboutDialog';
        ...
        >
          ...
          <button
            ...
            onClick={() => {
              ...
              setTourOpen(
                true,
                window.location.pathname.startsWith('/replay') ? 'replayer' : 'library',
              );
            }}
          >
            <IconCompass size={15} />
