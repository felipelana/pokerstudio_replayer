...
type Act =
  ['fold'] | ['check'] | ['call'] | ['bet', number] | ['raise', number] /* raise TO */ | ['allin'];
...
function generate(s: Script): string {
  ...
  for (const n of seatNos)
    L.push(`Seat ${n}: ${s.seats[n].name} (${m(s.seats[n].stack)} in chips)`);
    ...
    for (const [name, act] of acts) {
      ...
      switch (act[0]) {
        ...
        case 'raise': {
          ...
          lastAggressor = name;
          L.push(
            `${name}: raises ${m(r2(to - cur))} to ${m(to)}${allIn.has(name) ? ' and is all-in' : ''}`,
          );
          break;
        }
        case 'allin': {
          ...
          if (to > cur) {
            ...
            L.push(
              cur > 0
                ? `${name}: raises ${m(r2(to - cur))} to ${m(to)} and is all-in`
                : `${name}: bets ${m(to)} and is all-in`,
            );
          } else {
  ...
  for (const [label, acts, count] of streets) {
    ...
    if (label === 'FLOP') L.push(`*** FLOP *** [${cards.join(' ')}]`);
      ...
      L.push(`*** ${label} *** [${s.board.slice(0, count - 1).join(' ')}] [${cards[count - 1]}]`);
    boardShown = count;
  ...
  if (active.length === 1) {
    ...
    for (const n of active) {
      ...
      if (shown[n])
        winnersDesc[n] =
          won > 0
            ? `showed [${cards}] and won (${m(won)}) with ${nameOfRank(scores[n])}`
            : `showed [${cards}] and lost with ${nameOfRank(scores[n])}`;
    ...
    if (multi) {
      const sides = potsOut
        .slice(1)
        .map((p, i) =>
          potsOut.length === 2 ? `Side pot ${m(p.amount)}.` : `Side pot-${i + 1} ${m(p.amount)}.`,
        )
        .join(' ');
...
const scripts: Script[] = [
  ...
  base(
    1,
    {
      1: { name: V1, stack: 10.5 },
      2: { name: H, stack: 12, cards: ['Ah', 'Kd'] },
      3: { name: V2, stack: 9.85 },
      4: { name: V3, stack: 25 },
      6: { name: V4, stack: 10 },
    },
    2,
  ...
  base(
    2,
    {
      1: { name: V1, stack: 20.2 },
      2: { name: H, stack: 1.5, cards: ['Qc', 'Qs'] },
      3: { name: V2, stack: 9.8, cards: ['Ad', 'Kd'] },
      4: { name: V3, stack: 24.9, cards: ['5d', '5s'] },
      6: { name: V4, stack: 10 },
    },
    3,
    {
  ...
  base(
    ...
    {
      1: { name: V1, stack: 20.2 },
      2: { name: H, stack: 10, cards: ['2c', '7d'] },
      3: { name: V2, stack: 8.3 },
      4: { name: V3, stack: 27.8 },
      6: { name: V4, stack: 9.9 },
    },
    6,
    {
  ...
  base(
    6,
    {
      1: { name: V1, stack: 20, cards: ['2h', '3d'] },
      2: { name: H, stack: 10.05, cards: ['4s', '5c'] },
      3: { name: V2, stack: 8 },
      4: { name: V3, stack: 28 },
      6: { name: V4, stack: 10 },
    },
  ...
  base(
    7,
    {
      1: { name: V1, stack: 6, cards: ['Ah', '4s'] },
      2: { name: H, stack: 3.2, cards: ['Ks', 'Kd'] },
      3: { name: V2, stack: 12, cards: ['Qs', 'Qd'] },
      4: { name: V3, stack: 28 },
      6: { name: V4, stack: 10 },
    },
    6,
  ...
  base(
    8,
    {
      1: { name: V1, stack: 15, cards: ['9d', '9s'] },
      2: { name: H, stack: 10, cards: ['6h', '5h'] },
      3: { name: V2, stack: 8 },
      4: { name: V3, stack: 28 },
      6: { name: V4, stack: 10 },
    },
  ...
  base(
    9,
    {
      1: { name: V1, stack: 12, cards: ['Ad', 'Qc'] },
      2: { name: H, stack: 14, cards: ['7c', '7d'] },
      3: { name: V2, stack: 8 },
      4: { name: V3, stack: 28 },
      6: { name: V4, stack: 10 },
    },
  ...
  base(
    10,
    {
      2: { name: H, stack: 30, cards: ['Ah', '9h'] },
      5: { name: V5, stack: 26, cards: ['Kc', 'Kd'] },
    },
    2,
    {
  ...
  base(
    11,
    {
      1: { name: V1, stack: 4200, cards: ['Ac', 'Qd'] },
      2: { name: H, stack: 2300, cards: ['8h', '8s'] },
      3: { name: V2, stack: 9000 },
      4: { name: V3, stack: 6100 },
      5: { name: V5, stack: 12000 },
      6: { name: V4, stack: 5000 },
    },
    4,
    {
      ...TOUR,
  ...
  base(
    12,
    {
      1: { name: V1, stack: 2075, cards: ['Kc', 'Kh'] },
      2: { name: H, stack: 4825, cards: ['Ad', 'Jc'] },
      3: { name: V2, stack: 8975 },
      4: { name: V3, stack: 6075 },
      5: { name: V5, stack: 11875 },
      6: { name: V4, stack: 4975 },
    },
    5,
    {
      ...TOUR,
  ...
  base(
    13,
    {
      1: { name: V1, stack: 4600, cards: ['Qs', 'Js'] },
      2: { name: H, stack: 4300, cards: ['Th', '9h'] },
      3: { name: V2, stack: 8975 },
      4: { name: V3, stack: 6075 },
      5: { name: V5, stack: 11875 },
      6: { name: V4, stack: 4975 },
  ...
  base(
    14,
    {
      1: { name: V1, stack: 18, cards: ['Jd', 'Td'] },
      2: { name: H, stack: 22, cards: ['As', 'Ac'] },
      3: { name: V2, stack: 8 },
      4: { name: V3, stack: 28 },
      6: { name: V4, stack: 10 },
    },
  ...
  base(
    15,
    {
      1: { name: V1, stack: 20, cards: ['5c', '6c'] },
      2: { name: H, stack: 12, cards: ['Kh', '8d'] },
      3: { name: V2, stack: 8, cards: ['9h', '3h'] },
      4: { name: V3, stack: 28 },
      6: { name: V4, stack: 10 },
    },
    4,
  ...
  base(
    ...
    {
      1: { name: V1, stack: 20 },
      2: { name: H, stack: 12.6, cards: ['3d', '3c'] },
      3: { name: V2, stack: 8 },
      4: { name: V3, stack: 28 },
      6: { name: V4, stack: 10 },
    },
  ...
  base(
    17,
    {
      1: { name: V1, stack: 20, cards: ['Ks', 'Qs'] },
      2: { name: H, stack: 12.75, cards: ['Kd', 'Ad'] },
      3: { name: V2, stack: 8 },
      4: { name: V3, stack: 28 },
      6: { name: V4, stack: 10 },
    },
