...
export interface AdminUserDetail {
  user: AdminUserRow & { language: string; phoneE164?: string; referralCode: string; emailVerifiedAt?: string };
  sessions: { id: string; createdAt: string; expiresAt: string; revokedAt?: string; ip?: string; userAgent?: string }[];
...
export const adminApi = {
  ...
  block: (id: string, reason: string) => api.post<{ ok: true }>(`/admin/users/${id}/block`, { reason }),
