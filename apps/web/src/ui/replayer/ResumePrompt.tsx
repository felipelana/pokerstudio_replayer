 ...
 */
export function ResumePrompt({ handCount, onGoTo }: { handCount: number; onGoTo(index: number): void }) {
  ...
  return (
    ...
    >
      <p className="text-sm">{t('replayer.resumedAt', { current: resumedFrom + 1, total: handCount })}</p>
