...
import { systemApi, type HealthInfo } from '@/infrastructure/http/systemApi';
...
export function BuildFooter() {
  ...
  return (
    <footer className="flex flex-wrap items-center gap-2 text-xs" style={{ color: 'var(--text-muted)' }}>
